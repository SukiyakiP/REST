...
# PyInstaller spec for REST Inference GUI
# Model weights and artifact params are bundled into the exe.
...
a = Analysis(
    ...
    binaries=[],
    datas=[
        # Bundle the model weights and params file into the exe root (sys._MEIPASS)
        ('model_artifact.pth',   '.'),
